<div id="add-new-client" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative  bg-secondry   rounded-lg shadow">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-hide="add-new-client">
            ...
            <div class="p-4 md:p-5 bg-white rounded-b-lg">
                ...
                <div class="flex w-full  flex-col gap-4  ">
                    ...
                    <div class="w-full flex rounded-md justify-between   bg-gray-200 py-1 gap-2 px-1">
                        <button
                            class="flex  text-nowrap bg-white  text-primary font-bold rounded-md py-4   socialMeadiaLinks   px-4 justify-center items-center gap-2"
                            data-id="facbock">
                        ...
                        <button
                            class="flex  text-nowrap bg-transparent rounded-md py-4 socialMeadiaLinks   px-4 justify-center items-center gap-2"
                            data-id="snap">
                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="flex w-full flex-row gap-6  InputsLinks">



                        <div class="input-group w-1/2   flex flex-col gap-2">

                            <label class="text-[18px] ">اسم المستخدم على فيسبوك</label>
                            <div class="relative">
                                <input type="text" id="lable_name" data-lable="facbock" name="InputLabal"
                                    required
                                    class="w-full border InputLabal border-gray-300 focus:ring-0 text-[18px] h-12 rounded-md px-3"
                                    placeholder="اسم المستخدم على فيسبوك" value="">
                        ...
                        <div class="input-group w-1/2   flex flex-col gap-2">
                            ...
                            <div class="relative">
                                <input type="text" id="facbock" data-user-name="facbock"  name="userName" required
                ...
                @endif
                    ...
                    <div class="w-full flex justify-between items-center ">
                        <button
                            class="  text-nowrap py-4 flex justify-center items-center px-4 xl:px-10 rounded-md font-bold text-white gap-3 text-[18px] bg-secondry addNewClientSa">
                            <i
...
<script>
    ...
    let route=null;
    const routeType= "{!! $name !!}";

    if (routeType=='وكالة'){
         route = "{{ route('agencies.store') }}";
    }
    if (routeType!='وكالة'){
